...
def load_restaurant_data() -> List[Dict[str, str]]:
    ...
    try:
        ...
        print(f"📊 Loaded {len(restaurants)} restaurants for practical ML testing")
        return restaurants
...
async def test_practical_ml_scraper(sample_size: int = 20) -> Dict[str, Any]:
    ...
    print(f"\n🎯 STARTING PRACTICAL ML-INSPIRED SCRAPER TEST")
    print(f"📊 Sample size: {sample_size}")
    print(f"🎯 Target success rate: 50%+")
    print(f"🧠 Features: Smart navigation, ML-inspired allergen detection, confidence scoring")
    print("=" * 80)
    ...
    try:
        ...
        if not await scraper.setup_browser():
            print("❌ Failed to setup practical ML scraper browser")
            return results
        
        print(f"\n🔄 Testing {len(test_restaurants)} restaurants with practical ML features...\n")
        ...
        for i, restaurant in enumerate(test_restaurants, 1):
            ...
            if success:
                ...
                if dietary_tags_count > 0:
                    print(f"           🥗 Dietary Tags: {dietary_tags_count} detected")
...
def print_comprehensive_practical_ml_summary(results: Dict[str, Any]):
    ...
    print("\n" + "=" * 80)
    print("🎯 PRACTICAL ML-INSPIRED SCRAPER TEST RESULTS SUMMARY")
    print("=" * 80)
    ...
    print(f"   🧭 Navigation Success: {results['performance_metrics']['navigation_success_rate']}%")
    ...
    print(f"\n🧠 ML-INSPIRED ENHANCEMENT METRICS:")
    ...
    print(f"   🥗 Dietary Tags Detected: {allergen_metrics['dietary_tags_detected']}")
    ...
    if allergen_metrics['dietary_tag_distribution']:
        print(f"   🥗 Dietary Tag Distribution:")
    ...
    print(f"   🧭 Navigation success: {perf_metrics['navigation_success_rate']}%")
    ...
    if current_rate > best_previous:
        ...
        print(f"   ⚠️  Practical ML is {decline}% below best previous performance")
    
    # Practical ML recommendations
    print(f"\n🚀 PRACTICAL ML NEXT STEPS:")
    if results['success_rate'] >= 50:
        print(f"   • 🎯 TARGET ACHIEVED! Deploy practical ML scraper")
        print(f"   • 🧠 Implement full ML pipeline with training data")
        print(f"   • 📈 Add continuous learning from user feedback")
        print(f"   • 🔄 Integrate with AllergySavvy ML architecture")
    else:
        print(f"   • 🔍 Analyze navigation patterns for improvement")
        print(f"   • 🧠 Enhance ML-inspired allergen detection patterns")
        print(f"   • 📊 Collect training data for supervised learning")
        print(f"   • 🎯 Implement ensemble extraction methods")
        print(f"   • 🤖 Add NLP models for better text understanding")
    
    print(f"   • 🚨 Expand allergen database with regulatory compliance")
    print(f"   • 📱 Implement real-time confidence scoring")
    print(f"   • 🔄 Add user feedback loop for model improvement")
    print(f"   • 🌐 Scale to handle diverse restaurant website types")
    
    print("\n" + "=" * 80)
    print("✅ Practical ML-inspired test completed successfully!")
...
async def main():
    ...
    if results:
        ...
        print("❌ Practical ML test failed to complete")
